                ...
                <div class="d-flex flex-column">
                    ...
                    <nav id="navbar" class="nav-menu navbar">
                        <ul class="mx-auto">
                            ...
                            <li><a href="<?= home_url(); ?>/convert-maths" class="nav-link scrollto <?= is_current_url('/convert-maths') ? 'active' : '' ?>"><i class='bx bx-coin'></i> <span>Convertion Mathématiques</span></a></li>
                            <li><a href="<?= home_url(); ?>/pourcentage" class="nav-link scrollto <?= is_current_url('/pourcentage') ? 'active' : '' ?>"> <i class='bx bx-math'></i> <span>Pourcentage</span></a></li>
                            <li><a href="<?= home_url(); ?>/decimal-hexadecimal" class="nav-link scrollto <?= is_current_url('/decimal-hexadecimal') ? 'active' : '' ?>"> <i class='bx bx-table'></i> <span>Décimal en hexadécimal</span></a></li>
